...
#            f(v)
class Gif:
    def read(g, file_name):
        gif = file_name
        rg._bfType = struct.unpack('I', gif.read(4))
...
class Bmp:
    ...
    def read_from_file(s, file_name):  # Считываем BITMAPFILEHEADER и BITMAPINFO с готового bmp Файла
